...
export interface PackageConfig {
  /** Display name (e.g., 'OpenCapTable-v29') */
  name: string;
...
const PACKAGE_DEFS = {
  ocp: { name: 'OpenCapTable-v29', sourceDir: 'OpenCapTable-v29' },
...
/**
 * Get package config by short key (e.g., 'ocp') or full name (e.g., 'OpenCapTable-v29'). Key lookup is
 * case-insensitive.
 */
 ...
 *
 * @param packageKey - Package key (e.g., 'ocp') or full name (e.g., 'OpenCapTable-v29')
