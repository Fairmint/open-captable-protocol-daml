...
export interface PackageConfig {
  /** Display name (e.g., 'OpenCapTable-v30') */
  name: string;
...
const PACKAGE_DEFS = {
  ocp: { name: 'OpenCapTable-v30', sourceDir: 'OpenCapTable-v30' },
...
/**
 * Get package config by short key (e.g., 'ocp') or full name (e.g., 'OpenCapTable-v30'). Key lookup is
 * case-insensitive.
 */
 ...
 *
 * @param packageKey - Package key (e.g., 'ocp') or full name (e.g., 'OpenCapTable-v30')
