...
export interface PackageConfig {
  /** Display name (e.g., 'OpenCapTable-v31') */
  name: string;
...
const PACKAGE_DEFS = {
  ocp: { name: 'OpenCapTable-v31', sourceDir: 'OpenCapTable-v31' },
...
/**
 * Get package config by short key (e.g., 'ocp') or full name (e.g., 'OpenCapTable-v31'). Key lookup is
 * case-insensitive.
 */
 ...
 *
 * @param packageKey - Package key (e.g., 'ocp') or full name (e.g., 'OpenCapTable-v31')
