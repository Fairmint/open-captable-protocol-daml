...
export interface PackageConfig {
  /** Display name (e.g., 'OpenCapTable-v33') */
  name: string;
...
const PACKAGE_DEFS = {
  ocp: { name: 'OpenCapTable-v33', sourceDir: 'OpenCapTable-v33' },
...
/**
 * Get package config by short key (e.g., 'ocp') or full name (e.g., 'OpenCapTable-v33'). Key lookup is
 * case-insensitive.
 */
 ...
 *
 * @param packageKey - Package key (e.g., 'ocp') or full name (e.g., 'OpenCapTable-v33')
