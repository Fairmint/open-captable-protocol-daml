...
const generatedPackagePath = path.join(__dirname, '..', 'generated', 'js', 'OpenCapTable-v02-0.0.1', 'package.json');
...
// Create index files
const generatedDir = path.join(__dirname, '..', 'generated', 'js', 'OpenCapTable-v02-0.0.1');
