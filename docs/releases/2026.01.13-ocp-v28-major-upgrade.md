...
|---------|---------|-------------|
| **OpenCapTable-v30** | 0.0.1 | EditIssuer now returns EditIssuerResult |
...
3. **Template IDs** now use `OpenCapTable-v30`:
   - `#OpenCapTable-v30:Fairmint.OpenCapTable.OcpFactory:OcpFactory`
   - `#OpenCapTable-v30:Fairmint.OpenCapTable.Issuer:Issuer`
   - etc.
