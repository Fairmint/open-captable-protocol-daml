...
Patch release for `OpenCapTable-v32` adding a system-operator-only `ArchiveCapTable` choice for
...
|---------|---------|-------------|
| **OpenCapTable-v32** | 0.0.4 | Add ArchiveCapTable choice with empty-maps assertion |
...
3. **Version propagation**
   - Updated package references from `OpenCapTable-v32-0.0.3` to `OpenCapTable-v32-0.0.4`
