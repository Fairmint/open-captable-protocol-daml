...
package directory (e.g., `open-captable-protocol-daml/OpenCapTable-v30/README.md`).
...
- `open-captable-protocol-daml/OpenCapTable-v30/README.md` for Open Cap Table specifics (e.g.,
